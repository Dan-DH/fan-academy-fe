  ...
  return (
    <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
      ...
      <div className="mt-5 sm:mx-auto sm:w-full md:max-w-3xl p-5 rounded bg-white">
        ...
        <p className=" my-4  px-4 text-justify">
          Hey there! I'm <a className= "text-decoration-line: underline"href="https://github.com/Dan-DH">Daniel</a>, a full-stack developer based in Brussels, Belgium. I'm handling the development of the site, including coding the game logic from scratch.
        </p>
        <p className=" my-4  px-4 text-justify">
